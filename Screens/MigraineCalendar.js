...
export default function MigraineCalendar() {
  ...
  const getMigraineAttacks = async () => {
    try {
      const url = `${process.env.EXPO_PUBLIC_SERVER_URL}/migraineAttack/getMigraineAttacks/1`;
        ...
        <View style={styles.card}>
          <View style={styles.timeSection}>
            ...
            <Text style={styles.durationValue}>
              {calculateDuration(selectedMigraine.startTime, selectedMigraine.endTime)}
            </Text>
          </View>
        </View>
          ...
          <View style={styles.gridItem}>
            ...
            <View style={styles.intensityContainer}>
              <MaterialCommunityIcons
                ...
                color="#FF5252"
              />
              <Text style={styles.intensityText}>{selectedMigraine.intensity}/10</Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.migraineDataContainer}>
        ...
        {hasMigraine(selectedDate.getDate()) ? (
          ...
          <Text style={styles.noMigraineText}>No migraine recorded for this day.</Text>
        )}
      </View>
